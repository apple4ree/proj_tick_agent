# Commit Plan (Post v2-only Migration Hygiene) — Historical Record

> **Note:** This is a historical planning document from March 2026. Paths referenced here may no longer match the current repository layout.
